...
class Goat(Clickable, Drawable):
    def __init__(self, x, bottom, w = None, h = None):
        ...
        self.img_1 = utils.scale_image_maintain_ratio(config.images.get("goat"), w = w, h = h)
        self.img_2 = utils.scale_image_maintain_ratio(config.images.get("goat_idle"), w = w, h = h)
